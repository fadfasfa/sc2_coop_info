...
const publicSources = [
  ...
  '.github/workflows/ci.yml', '.github/workflows/shortcut-process-tests.yml',
  ...
  'tauri-overlay/src-tauri/src/bounded_process.rs',
  'tauri-overlay/src-tauri/src/desktop_shortcut.rs',
