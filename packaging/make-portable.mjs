...
fs.copyFileSync(path.join(packaging, '.github/workflows/windows-portable.yml'), path.join(output, 'packaging-source/windows-portable.yml'));
...
const manifest = {
  ...
  readiness: 'Built from merged main after automatic Windows gates; installation and human acceptance are separate deployment gates',
